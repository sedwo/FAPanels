...
extension FAPanelController {
    ...
    private func splitHorizontally( _ snapShot: UIImage) {
        ...
        UIView.animate(withDuration: configs.centerPanelTransitionDuration,
                       delay: 0,
    ...
    private func boxFade( _ snapShot: UIImage, to snapshotAfterSwap: UIImage) {
        ...
        DispatchQueue.main.async {
            ...
            for index in 0..<shuffledImages.count {
                ...
                UIView.animate(withDuration: self.configs.centerPanelTransitionDuration,
    ...
    internal func xPositionForLeftPanel( _ translationInX: CGFloat) -> CGFloat {
        ...
        if state == .center {
            ...
            if newPosition > 0.0 {
                return 0.0
            } else if newPosition < -widthForLeftPanelVC {
                return -widthForLeftPanelVC
            } else {
                return newPosition
            }
            ...
            if translationInX > 0.0 {
                return 0.0
            } else if translationInX < -widthForLeftPanelVC {
                return -widthForLeftPanelVC
            } else {
                return translationInX
            }
    ...
    internal func xPositionForRightPanel( _ translationInX: CGFloat) -> CGFloat {
        ...
        if state == .center {
            ...
            if newPosition > widthOfView {
                return widthOfView
            } else if newPosition < (widthOfView - widthForRightPanelVC) {
                return (widthOfView - widthForRightPanelVC)
            } else {
                return newPosition
            }
        } else if state == .right {
            ...
            if translationInX < 0.0 {
                return leftBareer
            } else if translationInX > widthForRightPanelVC {
                return widthOfView
            } else {
                return newPosition
            }
    ...
    internal func shouldCompletePanFor(movement: CGFloat) -> Bool {
        ...
        let minimum: CGFloat = floor(view.bounds.size.width * configs.minMovePercentage)
